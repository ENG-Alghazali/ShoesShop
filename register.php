...
if(isset($_POST['submit']))
{
   ...
   $select_user = $conn->prepare("SELECT * FROM `users` WHERE email = :email LIMIT 1");
   ...
   $insert_user = $conn->prepare("INSERT INTO `users`(`Name`, `email`, `password`) VALUES (:name, :email,:pass)");
            ...
            <div class="screen__content">
                <form class="login" method='post'>
                    ...
                    <div class="button login__submit">
                        <a href="login.php" style="text-decoration: none;"><span class="button__text">login</span></a>
                    </div>
